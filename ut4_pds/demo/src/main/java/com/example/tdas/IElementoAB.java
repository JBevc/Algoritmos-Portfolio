...
public interface IElementoAB<T> {
    ...
    /**
     * Inserta un elemento en el árbol y lleva el conteo de cuantas veces se llama el metodo.
     *
     * @param elemento Elemento a insertar.
     * @param contador Contador para llevar el conteo de los llamados recursivos.
     * @return Éxito de la operación.
     */
